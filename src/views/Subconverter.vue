...
export default {
  ...
  methods: {
    ...
    tanchuang() {
      this.$alert(`<div style="color: black;"><p>国庆7天优惠从今天已经开始了，<a href="https://www.mcwy.org" target="_blank" style="color: blue; text-decoration: underline;">mcwy</a>和各种流媒体、AI合租都有优惠，具体如下：</p>
<p>mcwy官网：<a href="https://www.mcwy.org" target="_blank" style="color: blue; text-decoration: underline;">https://www.mcwy.org</a></p>
...
<p>各种流媒体奈飞油管迪士尼HBO合租，AI合租官网：<a href="https://hezu.v1.mk" target="_blank" style="color: blue; text-decoration: underline;">https://hezu.v1.mk</a></p>
