    ...
    <el-row style="margin-top: 10px">
      <el-col>
        <el-card>
          ...
          <svg-icon id="gayhub" icon-class="github" style="margin-left: 10px" @click="goToProject" />
          <svg-icon id="dianbao" icon-class="telegram" style="margin-left: 10px" @click="gotoTgChannel" />
          ...
          <div id="youguan" style="float: right;margin-top:-10px">
