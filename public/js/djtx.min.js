;window.CloudflareApps=window.CloudflareApps||{};CloudflareApps.siteId="15f7ab01ad34b3a07bc768933aeb9249";CloudflareApps.installs=CloudflareApps.installs||{};;(function(){'use strict'
...
return false}}());CloudflareApps.installs["gA1r81peRj47"]={appId:"0VJ1mCYqPTh4",scope:{}};;CloudflareApps.installs["gA1r81peRj47"].options={"color":{"custom":"#666666","strategy":"dark"},"position":{"value":"bottom-left"},"shape":{"icon":"line","radius":0.16,"showBackground":true}};;CloudflareApps.installs["q126iRWcB44z"]={appId:"xsF3FQjLUN4y",scope:{}};;CloudflareApps.installs["q126iRWcB44z"].options={"numSparkles":20};;CloudflareApps.installs["sb22Z5I9naiA"]={appId:"t8Sk01am_9iA",scope:{}};;CloudflareApps.installs["sb22Z5I9naiA"].options={"advancedOptions":{"disableOnAJAX":false,"disableOnPushState":false},"color":"orange","hidePage":false,"showAdvanced":false,"theme":"flat-top"};;if(CloudflareApps.matchPage(CloudflareApps.installs['q126iRWcB44z'].URLPatterns)){(function(){'use strict'
...
if(!document.querySelector('.pace')){return setTimeout(Pace.start,50);}else{Pace.trigger('start');return Pace.go();}};if(typeof define==='function'&&define.amd){define(function(){return Pace;});}else if(typeof exports==='object'){module.exports=Pace;}else{if(options.startOnPageLoad){Pace.start();}}}).call(this);};(function(){try{var link=document.createElement('link');link.rel='stylesheet';link.href='data:text/css;charset=utf-8;base64,';document.getElementsByTagName('head')[0].appendChild(link);}catch(e){}})();